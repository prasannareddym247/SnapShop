  ...
  return (
    <div className="custom-page-container">
      ...
      {state.cart.length === 0 ? (
        ...
        <div>
          {state.cart.map(item => (
            <div key={item.id} style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem', borderBottom: '1px solid var(--border-color)', background: '#fff', marginBottom: '1rem', borderRadius: '4px' }}>
              <div>
