    ...
    <div>
      <section className="custom-hero">
        <div className="custom-hero-text">
          <span className="custom-badge">GarageTool Pro Exclusive</span>
          <h1>Heavy Duty Floor Jacks</h1>
          <p>Chrome vanadium steel socket wrench sets, diagnostic scanners, and dual-action orbital buffers.</p>
          <button className="custom-btn" onClick={() => state.navigate('category')}>Shop Now ✨</button>
        </div>
        <div className="custom-hero-visual">
          <img src="https://placehold.co/500x400/f3f4f6/dc2626?text=Hydraulic%20Jacks" alt="Hero Visual" className="custom-hero-img" />
        </div>
      </section>
