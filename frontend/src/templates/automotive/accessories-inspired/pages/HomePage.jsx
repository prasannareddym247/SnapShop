    ...
    <div>
      <section className="custom-hero">
        <div className="custom-hero-text">
          <span className="custom-badge">CarDecor Interiors Exclusive</span>
          <h1>Custom Fit Floor Mats</h1>
          <p>Memory foam neck rests, interior ambient LED lighting strips, and premium perfume diffusers.</p>
          <button className="custom-btn" onClick={() => state.navigate('category')}>Shop Now ✨</button>
        </div>
        <div className="custom-hero-visual">
          <img src="https://placehold.co/500x400/e0f2fe/2563eb?text=Ambient%20Dashboard" alt="Hero Visual" className="custom-hero-img" />
        </div>
      </section>
