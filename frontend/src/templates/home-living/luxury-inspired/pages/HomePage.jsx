    ...
    <div>
      <section className="custom-hero">
        <div className="custom-hero-text">
          <span className="custom-badge">LuxeInterior Casa Exclusive</span>
          <h1>Italian Velvet Loungers</h1>
          <p>Plush velvet couches, white marble dining sets, gold accent lamps, and silk throw pillows.</p>
          <button className="custom-btn" onClick={() => state.navigate('category')}>Shop Now ✨</button>
        </div>
        <div className="custom-hero-visual">
          <img src="https://placehold.co/500x400/fef3c7/b45309?text=Luxe%20Dining" alt="Hero Visual" className="custom-hero-img" />
        </div>
      </section>
