    ...
    <div>
      <section className="custom-hero">
        <div className="custom-hero-text">
          <span className="custom-badge">BlinkCart Quick Exclusive</span>
          <h1>Breakfast in 10 Minutes</h1>
          <p>Farm fresh milk, whole wheat bread, farm eggs, organic butter, and raw honey delivered instantly.</p>
          <button className="custom-btn" onClick={() => state.navigate('category')}>Shop Now ✨</button>
        </div>
        <div className="custom-hero-visual">
          <img src="https://placehold.co/500x400/fef3c7/f59e0b?text=Fresh%20Bread" alt="Hero Visual" className="custom-hero-img" />
        </div>
      </section>
