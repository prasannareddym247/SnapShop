    ...
    <div>
      <section className="custom-hero">
        <div className="custom-hero-text">
          <span className="custom-badge">NatureOrganics Exclusive</span>
          <h1>100% Pesticide Free</h1>
          <p>Fresh farm-harvested spinach, cold pressed sunflower oils, brown sugar, and green tea.</p>
          <button className="custom-btn" onClick={() => state.navigate('category')}>Shop Now ✨</button>
        </div>
        <div className="custom-hero-visual">
          <img src="https://placehold.co/500x400/d1fae5/059669?text=Organic%20Harvest" alt="Hero Visual" className="custom-hero-img" />
        </div>
      </section>
